 ...
 * @author Duy Quan
 */
public class Others extends Products implements Serializable{
    ...
    public void addProductMethod(){
        ...
        setName(sc.nextLine());
        System.out.print("Input product's weight: ");
        setWeight(Float.parseFloat(sc.nextLine()));
    ...
    public String toString(){
        return String.format("%s,%s,%s,%.1f,%.1f,%s,%s,%d",getType(),getCodeNum(),getName(),getWeight(),getCost(),getdOM(),getExD(),getInStock());
    }
}
